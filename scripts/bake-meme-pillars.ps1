# e6 중력 비행 — 밈 글자 기둥 원본(세로 조판 PNG)을 게임이 쓰는 webp 로 굽는다.
#
# 원본은 assets/images/minigame/geomatric fly 의 '<낱말>_세로.png' 여섯 장이다.
# 한 장에 한 낱말이 세로로 조판되어 있고 배경은 이미 지워져 있다(알파 컷아웃).
# 하는 일은 세 가지다.

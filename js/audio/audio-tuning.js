...
const ARCHIVE_AUDIO_TUNING_DEFAULTS = Object.freeze({
  ...
  sfx: {
    ...
    files: {
      ...
      sfxE2WaxCrack1: { label: "E2 · 껍질 균열 1", gain: 1.2, rate: 1, throttleMs: 120 },
      sfxE2WaxCrack2: { label: "E2 · 껍질 균열 2", gain: 1.35, rate: 1, throttleMs: 120 },
      sfxE2WaxDrop: { label: "E2 · 발판 낙하", gain: 0.38, rate: 1, throttleMs: 180 },
      sfxE2WaxJump: { label: "E2 · 점프", gain: 0.5, rate: 1, throttleMs: 75 },
      sfxE3SuccessCount: { label: "E3 · 목표선 1초 카운트", gain: 0.8, rate: 1, throttleMs: 0, maxVoices: 1 },
      sfxE3PersonFall: { label: "E3 · 바닥 추락 휘파람", gain: 0.48, rate: 1, throttleMs: 100 },
      ...
      sfxE5Broken1: { label: "E5 · 목표물 명중 1", gain: 0.55, rate: 1, throttleMs: 80, maxVoices: 2 },
      sfxE5Broken2: { label: "E5 · 목표물 명중 2", gain: 1.4, rate: 1, throttleMs: 80, maxVoices: 2 },
      ...
      sfxE10DigitWrong: { label: "E10 · 오답", gain: 0.34, rate: 1, throttleMs: 220 },
      sfxE10Jump: { label: "E10 · 회전 점프", gain: 0.7, rate: 1, throttleMs: 100 },
      sfxE10TouchNumber: { label: "E10 · 숫자 블록 접촉", gain: 0.62, rate: 1, throttleMs: 55 },
    },
    presets: {

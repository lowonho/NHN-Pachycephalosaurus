...
export const BOUNCE_COURSE = {
  ...
  walls: [
    ...
    { id: "p1", x: 196, y: 438, w: 30, h: 16 },
    { id: "p2", x: 131, y: 350, w: 28, h: 16 },
    { id: "p3", x: 251, y: 238, w: 28, h: 16 },
    { id: "p4", x: 434, y: 318, w: 26, h: 16 },
    { id: "p5", x: 570, y: 405, w: 26, h: 16 },
    { id: "p6", x: 661, y: 450, w: 28, h: 16 },
    { id: "end-floor", x: 794, y: 480, w: 32, h: 20 },

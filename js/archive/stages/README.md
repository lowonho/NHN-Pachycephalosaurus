...
| e2 | e2_bounceBall.js | speed, jump, jumpLoss, minJump, gravity, radius |
...
- e2는 A/D 좌우, W/S 공중 수직 보정, Space 착지 후 점프입니다. 왁뿌볼의 민트색 껍질에 점프마다 균열이 추가되고 조각이 떨어져 분홍색 속이 드러납니다. 첫 점프 속도는 480이며 한 번 뛸 때마다 다음 점프 속도가 38씩 줄고 최저 260을 유지합니다. 공중 연타나 키를 길게 누르는 것은 파손을 추가하지 않습니다. 충돌/사망 후에도 파손과 약해진 점프력을 유지하고, 결과의 다시하기에서는 초기화합니다. 약해진 점프로도 건널 수 있도록 발판 간격을 85→80→80→75→70→65로 줄였습니다. 플랫폼에 착지하면 체크포인트를 갱신합니다.

...
(function (global) {
  ...
  global.MINIGAME_CATALOG = Object.freeze([
    ['e1', '거제 야호', '⇅', 'Space 중력 반전', '바닥 벽과 천장 벽을 오가며 움직이는 장애물을 피해 골인하세요.', '장애물은 중력을 반전할수록 더 많이 움직인다', '반전'],
    ['e2', '왁뿌볼 살리기', '◉', 'A/D 이동 · Space 점프', '승강 발판과 무너지는 발판을 건너 골인하세요.', '후반까지 점프력 감소 · 파손 유지', '점프'],
    ['e3', '메챠 쌓기', E3_PERSON_ICON, 'A/D 또는 ←/→ 회전 · Space / 클릭으로 떨어뜨리기', '떨어뜨릴 사람을 원하는 각도로 돌려 쌓고 목표 높이에서 2초 버티세요.', '낙하마다 좌우 속도 증가 · 단상 밖으로 떨어지면 사라짐', '낙하'],

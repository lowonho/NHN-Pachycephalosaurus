...
(function exposeScenarioData(global) {
  ...
  const cutscenes = Object.freeze({
    opening: Object.freeze({ id: "00", chapter: "OPENING // ARCHIVE ENTRY", auto: false, script: freeze([
      ...
      system("SOURCE RECORD: ABSENT\nWITNESS MATCH: 100%", "op-03", 1000),
      cue("ARIA-26", "참조할 기록이 없는데도 재현했습니다.", "op-03", 1900),
      system("GLOBAL RECALL: 0%\nLOCAL SUBJECT RECALL: 100%", "op-05", 900),
      cue("ARIA-26", "단 한 사람. 당신만 제외하고.", "op-05", 1300),
      system("EXPOSURE OVERFLOW\nCOMPLETE MEMORY HOLDER\n\n완전기억 소지자 확인\n기억 수정 저항률: 100%\n최종 증언 권한: 승인", "op-05", 1600),
      cue("ARIA-26", "당신은 기록 그 자체입니다.", "op-05", 2200),
      system("2026 ARCHIVE DELETION\nDELETION IN PROGRESS\nORIGINAL INDEX: 12%", "op-09", 900),

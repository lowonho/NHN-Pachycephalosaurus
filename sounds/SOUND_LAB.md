...
크로스페이드 시간을 관리합니다. 기본 배정은 메인과 E1~E10까지 모두 연결되어 있습니다.
...
1. 원본은 `sounds/sfx/`에 WAV 48 kHz, 16/24 bit로 넣습니다.
...
5. 파일이 오기 전에는 `SFX_SYNTH_FALLBACKS`를 통해 합성 프리셋으로 판정 타이밍부터 검수합니다.
